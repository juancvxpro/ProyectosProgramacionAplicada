...
public class ClientesFijosPuesto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Historial Clientes Fijos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14))); // NOI18N
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (txtCedula.getText().isEmpty()) {
            ...
            if (clienteFijo != null) {
                ...
                HistorialClientesFijos historial = new HistorialClientesFijos();//fecha,"Entra cliente "+ " con cedula:" +clienteFijo.getCedula()+" el "+f+" "+h,clienteFijo);
                historial.setFechaHora(fecha);
                historial.setDescripcion("Entra cliente " + " con cedula:" + clienteFijo.getCedula() + " el " + f + " " + h);
    ...
    private void btnIngresar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresar1ActionPerformed
        ...
        if (txtCedula.getText().isEmpty()) {
            ...
            if (clienteFijo != null) {
                ...
                // HistorialClientesFijos historial = new HistorialClientesFijos(fecha,"Sale cliente "+ " con cedula:" +clienteFijo.getCedula()+" el "+f+" "+h,clienteFijo);
                HistorialClientesFijos historial = new HistorialClientesFijos();
                historial.setFechaHora(fecha);
                historial.setDescripcion("Sale cliente " + " con cedula:" + clienteFijo.getCedula() + " el " + f + " " + h);
                historial.setClienteF(clienteFijo);
                //int id, Calendar FechaHora, String descripcion, ClienteFijo clienteF
