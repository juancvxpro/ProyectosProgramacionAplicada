...
public class RegistrarUsuario extends javax.swing.JInternalFrame {
     ...
     */
    public RegistrarUsuario(Controlador controlador) {
        initComponents();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        for (int i = 0; i < pass1.length; i++) {
          ...
          Usuario usuario = new Usuario(0,txtGcedula.getText(), txtGnombre.getText(), txtGapellido.getText(), txtGcorreo.getText(), pass);
