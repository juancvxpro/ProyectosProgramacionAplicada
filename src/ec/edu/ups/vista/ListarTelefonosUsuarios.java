...
public class ListarTelefonosUsuarios extends javax.swing.JInternalFrame {
    ...
    public ListarTelefonosUsuarios(ControladorTelefono controladorTelefono, ControladorUsuario controladorusuario) {
    ...
    public void cargarTelefonosTbl() {
        ...
        comparar.setCedula(txtCedula.toString().trim());
        Optional<Usuario> usuario = controladorUsuario.buscar(comparar);
        modelo.setRowCount(0);
        for (Telefono t : controladorTelefono.listaTlfsUsers(usuario)) {
