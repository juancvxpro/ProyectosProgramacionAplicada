...
public final class GestionTelefono extends javax.swing.JInternalFrame {
    ...
    public void cargarTelefonosTbl() {
        DefaultTableModel modelo = (DefaultTableModel) tblTelefonos.getModel();
        modelo.setRowCount(0);
        for (Telefono telefono : controladorTelefono.getLista()) {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        Telefono t;
        t = new Telefono(Integer.parseInt(txtCodigo.getText().trim()), cbxTipo.getSelectedItem().toString().trim(), txtFormatoNumero.getText().trim(), cbxOperadora.getSelectedItem().toString().trim());
        t.setUsuario(controladorUsuario.getUsuario());
        if (controladorTelefono.crear(t)) {
